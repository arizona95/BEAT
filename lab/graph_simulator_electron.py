...
class web_parser :
    ...
    def parse(self, data):
        log(data["graph"].replace("$","\""))
        json_data = json.loads(data["graph"].replace("$","\""))
...
if __name__ == "__main__" :
    ...
    state = json.loads(sys.argv[3].replace("$","\""))
